  ...
  return (
    <section className='sm:w-[100%] md:w-[50%]'>
      ...
      > 
        ...
        <textarea id="textContent" name="textContent" className='w-[80%] my-4 border-mainColor border-2 rounded-xl p-2 outline-accentColor' defaultValue={"Cole o texto nesta área"} rows={10} />
